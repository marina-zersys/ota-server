            ...
            <tbody class="divide-y divide-white/5">
                ...
                <tr class="hover:bg-white/5 transition">
                    <td class="px-6 py-3 font-medium text-white">
                        <a href="{{ route('dashboard.app-detail', $release->app_name) }}" class="hover:text-purple-300 transition">{{ $release->app_name }}</a>
                    </td>
                    <td class="px-6 py-3">
                ...
                @empty
                <tr>
                    <td colspan="7" class="px-6 py-8 text-center text-gray-500">No releases yet.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
